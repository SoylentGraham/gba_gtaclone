...
void set_sprite_tile(a_sprite *sprite, u16 tile)
{
	...
	sprite->attribute2 = tile*2 ;
	sprite->attribute2 |= pri ;
}
...
void init_sprite( a_sprite *sprite, u16 size, u8 obj_set, u8 obj_tile, u8 priority, u8 rot_id )
{
