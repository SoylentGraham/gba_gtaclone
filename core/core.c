...
void set_mode(u8 mode,u16 bgs,u8 sprites)
{
	...
	REG_BG1CNT = CHAR_BLOCK_REGISTER(0) | BG_PRIORITY(1) | BG_MOSAIC | BG_COLOR_256(1) | SCREEN_BLOCK_REGISTER(1) ;
	REG_BG2CNT = CHAR_BLOCK_REGISTER(0) | BG_PRIORITY(2) | BG_MOSAIC | BG_COLOR_256(1) | SCREEN_BLOCK_REGISTER(2) ;
	REG_BG3CNT = CHAR_BLOCK_REGISTER(0) | BG_PRIORITY(3) | BG_MOSAIC | BG_COLOR_256(1) | SCREEN_BLOCK_REGISTER(3) ;
